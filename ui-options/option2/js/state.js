...
const Instructions = {
  [States.IDLE]: {
    ...
    text: 'Mark the road area by painting over it. The brush tool is ready — click and drag on the video to paint the road surface you want to annotate.',
  },
  [States.DRAWING_POLYGON]: {
    icon: 'brush-tool',
    text: 'Click and drag to paint the road area. The thick brush stroke will define the road region. Release the mouse to complete the selection. Press Escape to cancel.',
  },
  [States.LABELING]: {
    icon: 'type',
